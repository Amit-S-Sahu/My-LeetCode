class MovieRentingSystem {
    ...
    private static Comparator<Node> CMP =
        (a, b) -> {
    ...
    private Map<Integer, TreeSet<Node>> availableByMovie = new HashMap<>();
    private TreeSet<Node> rentedSet = new TreeSet<>(CMP);
    private Map<Long, Node> byPair = new HashMap<>();
